...
The `RaceDayAPI Plan.docx` contains tables that cover the Authentication, User Profile, Events, Categories, Event Enrolments, and Results factors whereas each row includes HTTP method, route, description, required role, request body, and expected responses including the failure codes.
